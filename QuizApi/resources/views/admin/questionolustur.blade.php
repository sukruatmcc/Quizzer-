<x-app-layout>
<x-slot name="header">{{$quiz->title}} Yeni Soru Oluştur</x-slot>
<div class="card">
  <div class="card-body">
    <form method="post" action="{{route('questionsEkle',$quiz->id)}}" enctype="multipart/form-data">
      @csrf
        ...
        <br>
        <div class="form-group">
            <button class="btn btn-success btn-sm btn-block">Question Oluştur</button>
        </div>
    </form>
  </div>
</div>
